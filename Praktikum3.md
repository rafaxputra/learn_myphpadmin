...
4.	Tambahkan data penjualan sebagaimana berikut : <SOAL 2>
- kode_penjualan = 2 
...
5.	Solusi agar data pada soal 2 dapat ditambahkan <SOAL 3 > yaitu dengan merubah dahulu nilai dari kode_penjualan Doni yang awalnya 2 menjadi 4
...
8.	Solusi agar data pada soal 4 dapat ditambahkan <SOAL 5> yaitu tidak ada solusi karena data dapat ditambahkan
9.	Yang bisa saya pahami dari soal 1-5 terkait dengan duplikasi dan inkonsisten data <Soal 6> 
